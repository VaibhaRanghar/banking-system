...
export const getUserInfo = async ({ userId }: getBanksProps) => {
  try {
...
export const signUp = async ({ password, ...userData }: SignUpParams) => {
  ...
  try {
    ...
    console.log("SIGN UP KA ERROR = ", error);
  }
};
...
export async function getLoggedInUser() {
  try {
    ...
    console.log("LOGGED IN USER KA error:", error);
    return null;
  }
}
...
export const createLinkToken = async (user: User) => {
  try {
    ...
    console.log("PLAID LINK TOKEN KA ERROR = ", error);
  }
};
